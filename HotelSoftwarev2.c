...
struct room {
  char type [7];
  int available;  //1 - available and 0 - not available
  int id;
  int rate;  //rate of the room
  int stayCharge;
  int foodCharge;
  int grandTotal;
...
void checkOut()  //extra: make the values of total, food charge and room charge zero here
 {
   //clrscr();
   //screenheader();
